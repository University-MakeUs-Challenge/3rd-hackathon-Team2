...
let CenterData: [CenterModel] = [
    ...
    CenterModel(centerID: 0, categoryName: "복싱", centerName: "홍수환스타복싱체육관", phoneNum: "0507-1401-7845", regionName: "강남구", latitude:37.5026426, longitude: 127.0506822, openTime: 10, closeTime: 22),
